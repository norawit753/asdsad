(function (window, undefined) {
  ...
  AcceptCookie.prototype = {
    ...
    appendCss: function () {
      ...
      cssCode +=
        "#pjAcceptCookieBar { position: fixed; bottom: 0; left: 0; z-index: 9999; overflow-x: hidden; overflow-y: auto; width: 100%; max-height: 100%; padding: 15px 0; background-color:rgba(0,0,0,.7);  font-family: 'Open Sans', sans-serif; text-align: center; }";
      cssCode +=
      ...
      cssCode +=
        "#pjAcceptCookieBar a:link {text-decoration: underline ; color: #fff;}";
      cssCode +=
        "#pjAcceptCookieBar a:visited {text-decoration: underline ; color: #fff;}";
      cssCode +=
        "#pjAcceptCookieBar a:active {text-decoration: underline ; color: #fff;}";
      cssCode +=
        "#pjAcceptCookieBar a:hover {text-decoration: underline ; color: #fff;}";
      //cssCode += "#pjAcceptCookieBar a:focus,";
      cssCode +=
        "#pjAcceptCookieBar button:focus { outline: unset; outline: none; }";
      cssCode +=
        "#pjAcceptCookieBar p { font-size: 16px; line-height: 1.2; color: #fff; font-weight: 200; }";
      cssCode +=
        "#pjAcceptCookieBar .pjAcceptCookieBarActions { padding-top: 10px; }";
      cssCode +=
        "#pjAcceptCookieBar .pjAcceptCookieBarBtn { position: relative; display: inline-block; height: 46px; padding: 0 30px; border: 0; background: #4285f4; font-size: 16px; line-height: 44px; color: #fff; text-decoration: none; vertical-align: middle; cursor: pointer; border-radius: 25px; -webkit-appearance: none; -webkit-border-radius: 0; -webkit-transform: translateZ(0); transform: translateZ(0); -webkit-backface-visibility: hidden; backface-visibility: hidden; -moz-osx-font-smoothing: grayscale; }";
    ...
    addCookieBar: function () {
      ...
      htmlBar +=
        "<p>ทางคณะวิทยาศาสตร์มีการใช้งานคุกกี้ (Cookies) เพื่อจัดการข้อมูลส่วนบุคคลและช่วยเพิ่มประสิทธิภาพการใช้งานเว็บไซต์ ท่านสามารถศึกษารายละเอียดเพิ่มเติมและการตั้งค่าคุกกี้ได้ที่  ";
      htmlBar +=
        '<a href="http://science.swu.ac.th/Default.aspx?tabid=20330&language=th-TH" target="_blank">นโยบายการใช้คุ้กกี้</a> &nbsp;&nbsp;&nbsp;';
      //htmlBar += '<div class="pjAcceptCookieBarActions">';
      htmlBar +=
        '<button type="button" class="pjAcceptCookieBarBtn">ปิด</button></p>';
      //htmlBar += '</div>';
      htmlBar += "</form>";
      htmlBar += "</div>";
